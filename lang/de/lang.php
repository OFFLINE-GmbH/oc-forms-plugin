...
return [
    ...
    'success_script_comment' => 'Wird nach dem Absenden des Formulars ausgeführt. Formulardaten sind in den Variablen `window.ocForms.data` und  `window.ocForms.submission` verfügbar.',
    ...
    'dropdown_comment' => 'Einfachauswahl',
    'options' => 'Optionen',
    'number' => 'Zahl',
    'date' => 'Datum',
    'time' => 'Uhrzeit',
